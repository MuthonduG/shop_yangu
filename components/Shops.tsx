    ...
    <div className="w-screen flex flex-col justify-center items-center">
      <div className="xl:w-[65%] md:w-[85%] border p-2 rounded-xl bg-slate-100">
        <form action="" className="flex gap-4 justify-center items-center">
            <input type="text"  className="w-[80%] p-2 bg-transparent border-transparent border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Search by category"/>
